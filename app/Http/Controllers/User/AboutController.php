...
class AboutController extends Controller
{
    ...
    public function history()
    {
        ...
        return view('user.about.history', compact('history'));
    }
    ...
    public function visionMission()
    {
        ...
        return view('user.about.vision-mission', compact('vision', 'missions', 'values'));
    }
    ...
    public function organization()
    {
        ...
        return view('user.about.organization', compact('structure'));
    }
}
