...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        */
        ...
        /*
        =========================================
        INDEX - NON CONSTRUCTION SERVICE
        =========================================
        */
        DB::table('services')->insert([
            'section' => 'non_construction',
            'data' => json_encode([
                [
        ...
        */
        DB::table('services')->insert([
            'section' => 'construction_consultancy',
            'data' => json_encode([
                [
                    'code' => 'AR001',
        ...
        /*
        =========================================
        NON CONSTRUCTION CONSULTANCY
        =========================================
        */
        DB::table('services')->insert([
            'section' => 'non_construction_consultancy',
            'data' => json_encode([
                [
