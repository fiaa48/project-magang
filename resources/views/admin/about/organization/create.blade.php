{{-- resources/views/admin/about/organization/create.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Tambah Anggota Organisasi - Admin Panel')
            ...
            <div class="card-ultra">
                <div class="form-container">
                    <div class="form-title">
                        ...
                        <span>Tambah Anggota Organisasi</span>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.about.organization.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control-premium" required>
                                ...
                                <option value="direksi" {{ old('category') == 'direksi' ? 'selected' : '' }}>Direksi</option>
                                <option value="komisaris" {{ old('category') == 'komisaris' ? 'selected' : '' }}>Komisaris</option>
                                <option value="pemegang_saham" {{ old('category') == 'pemegang_saham' ? 'selected' : '' }}>Pemegang Saham</option>
                                <option value="divisi" {{ old('category') == 'divisi' ? 'selected' : '' }}>Divisi</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control-premium" value="{{ old('name') }}" required placeholder="Contoh: Ir. Ahmad Sudirman, M.M.">
                        </div>

                        <!-- Posisi / Jabatan -->
                        <div class="form-group">
                            <label for="position">Jabatan / Posisi</label>
                            <input type="text" name="position" id="position" class="form-control-premium" value="{{ old('position') }}" placeholder="Contoh: Ketua Dewan Komisaris">
                        ...
                        <div class="form-group" id="shares-group">
                            ...
                            <input type="text" name="shares" id="shares" class="form-control-premium" value="{{ old('shares') }}" placeholder="Contoh: 25.5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="value" id="value" class="form-control-premium" value="{{ old('value') }}" placeholder="Contoh: Komisaris Independen">
