...
@section('title', 'Tambah Profil Perusahaan - Admin Panel')
...
<div class="container-fluid px-0 px-lg-2">
    <div class="page-header-premium">
        <div class="page-title-premium">
            ...
            <span>Tambah Profil Perusahaan</span>
        </div>
    </div>
    ...
    <div class="card-ultra">
        <div class="card-body p-4 p-lg-5">
            ...
            <form action="{{ route('admin.about.profile.store') }}" method="POST" id="premiumForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="name" class="form-control-premium @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="PT. Nusantara Sejahtera" required>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                <i class="fas fa-building input-icon"></i>
                                <input type="text" name="type" class="form-control-premium @error('type') is-invalid @enderror" value="{{ old('type') }}" placeholder="PT, CV, Firm, dll">
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <textarea name="address_main" class="form-control-premium @error('address_main') is-invalid @enderror" rows="3" placeholder="Jl. Sudirman No. 123, Jakarta Pusat">{{ old('address_main') }}</textarea>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                <i class="fas fa-location-dot input-icon" style="top: 1.2rem;"></i>
                                <textarea name="address_branch" class="form-control-premium @error('address_branch') is-invalid @enderror" rows="2" placeholder="Jl. Pemuda No. 45, Surabaya">{{ old('address_branch') }}</textarea>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="number" name="established_year" class="form-control-premium @error('established_year') is-invalid @enderror" value="{{ old('established_year') }}" placeholder="2010" min="1900" max="{{ date('Y') }}">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="npwp" class="form-control-premium @error('npwp') is-invalid @enderror" value="{{ old('npwp') }}" placeholder="12.345.678.9-012.345">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="nib" class="form-control-premium @error('nib') is-invalid @enderror" value="{{ old('nib') }}" placeholder="Nomor Induk Berusaha">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="association" class="form-control-premium @error('association') is-invalid @enderror" value="{{ old('association') }}" placeholder="APINDO, KADIN, dll">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="telepon_pt" class="form-control-premium @error('telepon_pt') is-invalid @enderror" value="{{ old('telepon_pt') }}" placeholder="(021) 1234567">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="email" name="email_pt" class="form-control-premium @error('email_pt') is-invalid @enderror" value="{{ old('email_pt') }}" placeholder="info@perusahaan.com">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="website_pt" class="form-control-premium @error('website_pt') is-invalid @enderror" value="{{ old('website_pt') }}" placeholder="www.perusahaan.com">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                ...
                                <input type="text" name="inkindo" class="form-control-premium @error('inkindo') is-invalid @enderror" value="{{ old('inkindo') }}" placeholder="Nomor anggota Inkindo">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-premium">
                            ...
                            <div class="input-group-premium">
                                <i class="fas fa-building input-icon"></i>
                                <input type="text" name="kadin" class="form-control-premium @error('kadin') is-invalid @enderror" value="{{ old('kadin') }}" placeholder="Nomor anggota Kadin">
                            </div>
                            ...
                            <div class="input-group-premium">
                                ...
                                <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap; background: var(--cream); border: 1px solid rgba(141,110,99,0.2); border-radius: 1rem; padding: 0.5rem 1rem 0.5rem 2.8rem; width: 100%;">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_pkp_active" name="is_pkp_active" value="1" {{ old('is_pkp_active') ? 'checked' : '' }} style="cursor: pointer; width: 2.5rem; height: 1.3rem;">
                    ...
                    <div class="col-md-6" id="pkp_date_group" style="{{ old('is_pkp_active') ? '' : 'display: none;' }}">
                        <div class="form-group-premium">
                            <label class="form-label-premium"><i class="fas fa-calendar-alt"></i> Tanggal Pengukuhan PKP</label>
                            <div class="input-group-premium">
                                <i class="fas fa-calendar-day input-icon"></i>
                                <input type="date" name="pkp_activation_date" class="form-control-premium @error('pkp_activation_date') is-invalid @enderror" value="{{ old('pkp_activation_date') }}">
                            </div>
                ...
                <div class="d-flex flex-wrap justify-content-between gap-3 mt-4 pt-3">
                    ...
                    <button type="submit" class="btn-premium-ultra" id="submitBtn"><i class="fas fa-save"></i> Simpan Profil</button>
                </div>
            </form>
        </div>
    </div>
