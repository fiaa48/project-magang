...
<style>
    ...
    * {
    ...
    @media (max-width: 768px) {
        ...
        .btn-remove-row { align-self: flex-start; }
            ...
            <div class="card-ultra">
                <div class="form-container">
                    <div class="form-title">
                        ...
                        <span>Edit Visi & Misi Perusahaan</span>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.about.vision.update', $data->id) }}" id="mainForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="vision" id="vision" class="form-control-premium" rows="4" required placeholder="Tuliskan visi perusahaan...">{{ old('vision', $data->vision) }}</textarea>
                        </div>
                            ...
                            <div id="missions-container">
                                ...
                                @forelse($missions as $index => $mission)
                                    <div class="dynamic-row">
                                        <input type="text" class="form-control-premium" placeholder="Misi" name="missions[]" value="{{ old('missions.'.$index, $mission) }}">
                                        <button type="button" class="btn-remove-row" {{ $loop->first && $missionCount <= 1 ? 'style="display: none;"' : '' }}><i class="fas fa-trash-alt"></i> Hapus</button>
                                    </div>
                                @empty
                                    <div class="dynamic-row">
                                        <input type="text" class="form-control-premium" placeholder="Misi" name="missions[]">
                        ...
                        <div class="form-group">
                            ...
                            <div id="values-container">
                                ...
                                @endphp
                                @forelse($values as $key => $val)
                                    <div class="dynamic-row dual">
                                        <input type="text" class="form-control-premium" placeholder="Key" name="value_keys[]" value="{{ old('value_keys.'.$loop->index, $key) }}">
                                        <input type="text" class="form-control-premium" placeholder="Value" name="value_values[]" value="{{ old('value_values.'.$loop->index, $val) }}">
                                        <button type="button" class="btn-remove-row" {{ $loop->first && $valueCount <= 1 ? 'style="display: none;"' : '' }}><i class="fas fa-trash-alt"></i> Hapus</button>
                                    </div>
                                @empty
                                    <div class="dynamic-row dual">
