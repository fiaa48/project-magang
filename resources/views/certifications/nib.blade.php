...
<div class="container py-5">
    <h2 class="mb-4 fw-bold text-center">DOKUMEN NIB</h2>
    ...
    <div class="row">
        ...
        @empty
            <div class="text-center py-5">
                <h5 class="text-muted">Belum ada dokumen NIB.</h5>
                <p class="text-muted small">
                    Upload file ke folder: <b>public/certificates/nib</b>
                </p>
            </div>
        @endforelse
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content border-0 rounded-4 shadow">
      ...
      <div class="modal-header border-0">
          <h5 class="modal-title fw-semibold">Preview Dokumen NIB</h5>
...
function openModal(imageUrl, downloadUrl) {
    ...
    document.getElementById('waBtn').href =
        "https://wa.me/?text=" + encodeURIComponent("Lihat Dokumen NIB: " + imageUrl);

    document.getElementById('emailBtn').href =
        "mailto:?subject=Dokumen NIB&body=Lihat Dokumen NIB: " + imageUrl;
