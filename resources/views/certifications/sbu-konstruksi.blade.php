...
<div class="container py-5">
    <h2 class="mb-4 fw-bold text-center">SERTIFIKAT SBU KONSTRUKSI</h2>
    ...
    <div class="row">
        ...
        <div class="text-center py-5">
            <h5 class="text-muted">Belum ada sertifikat SBU Konstruksi.</h5>
            <p class="text-muted small">
                Upload sertifikat di folder: <b>public/certificates/sbu-konstruksi</b>
            </p>
        </div>
        @endforelse
    </div>
...
function openModal(imageUrl, downloadUrl) {
    ...
    document.getElementById('waBtn').href =
        "https://wa.me/?text=" + encodeURIComponent("Lihat Sertifikat SBU Konstruksi: " + imageUrl);

    document.getElementById('emailBtn').href =
        "mailto:?subject=Sertifikat SBU Konstruksi&body=Lihat Sertifikat: " + imageUrl;
