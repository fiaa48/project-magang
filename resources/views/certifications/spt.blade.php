...
<div class="container py-5">
    ...
    <div class="row">
        ...
        <div class="text-center py-5">
            <h5 class="text-muted">Belum ada dokumen SPT.</h5>
            <p class="text-muted small">
                Upload file ke folder: <b>public/certificates/spt</b>
            </p>
        </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content border-0 rounded-4 shadow">
      ...
      <div class="modal-header border-0">
          <h5 class="modal-title fw-semibold">Preview Dokumen SPT</h5>
...
function openModal(imageUrl, downloadUrl)
{
    ...
    document.getElementById('waBtn').href =
        "https://wa.me/?text=" +
        encodeURIComponent("Lihat Dokumen SPT: " + imageUrl);

    document.getElementById('emailBtn').href =
        "mailto:?subject=Dokumen SPT&body=" +
        encodeURIComponent("Lihat Dokumen SPT: " + imageUrl);
