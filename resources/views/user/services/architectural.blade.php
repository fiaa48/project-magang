...
@section('content')
    ...
    <section class="architectural-hero position-relative overflow-hidden">
                ...
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-nav mt-5 animate-fade-in-up" style="animation-delay: 0.4s;">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item active text-brown-dark">Jasa Arsitektural</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="scroll-indicator">
            <a href="#services" class="scroll-down"><i class="fas fa-chevron-down"></i></a>
        </div>
    </section>
    ...
    <!-- PROCESS SECTION – 3D STEPS (tetap dipertahankan) -->
                ...
                <div class="col-lg-2-4 col-md-6">
                    <div class="process-step-3d animate-on-scroll">
                        <div class="process-step-inner">
                            ...
                            <div class="step-icon"><i class="fas fa-comments fa-3x"></i></div>
                ...
                <div class="col-lg-2-4 col-md-6">
                    <div class="process-step-3d animate-on-scroll">
                        <div class="process-step-inner">
                            ...
                            <div class="step-icon"><i class="fas fa-search-location fa-3x"></i></div>
                ...
                <div class="col-lg-2-4 col-md-6">
                    <div class="process-step-3d animate-on-scroll">
                        <div class="process-step-inner">
                            ...
                            <div class="step-icon"><i class="fas fa-lightbulb fa-3x"></i></div>
                ...
                <div class="col-lg-2-4 col-md-6">
                    <div class="process-step-3d animate-on-scroll">
                        <div class="process-step-inner">
                            ...
                            <div class="step-icon"><i class="fas fa-pencil-ruler fa-3x"></i></div>
                ...
                <div class="col-lg-2-4 col-md-6">
                    <div class="process-step-3d animate-on-scroll">
                        <div class="process-step-inner">
                            ...
                            <div class="step-icon"><i class="fas fa-check-circle fa-3x"></i></div>
...
@push('styles')
<style>
    /* ===== GAYA PREMIUM (tetap sama seperti sebelumnya, tidak ada perubahan) ===== */
    :root {
        --brown-dark: #241b64;
        --brown-medium: #302574;
        --brown-light: #A1887F;
