...
@section('content')
        ...
        <div class="container position-relative z-2">
            <div class="section-header text-center mb-6">
                <span class="badge bg-brown-dark text-white rounded-pill px-4 py-2 mb-3">
                    <i class="fas fa-hard-hat me-2"></i>KONSULTANSI KONSTRUKSI
                </span>
                ...
                <p class="lead text-brown-medium mx-auto" style="max-width: 600px;">
                    Layanan konsultansi untuk proyek-proyek konstruksi dengan standar tertinggi.
                </p>
            </div>
                ...
                <div class="col-md-4">
                    <div class="service-card-3d animate-on-scroll">
                        <div class="service-card-inner">
                            ...
                            <a href="{{ route($service['route'] ?? '#') }}" class="btn btn-outline-brown-3d w-100 rounded-pill">
    ...
    <!-- NON-CONSTRUCTION SERVICES SECTION -->
    <section class="py-6 bg-cream-light position-relative overflow-hidden">
        ...
        <div class="container position-relative z-2">
            <div class="section-header text-center mb-6">
                <span class="badge bg-brown-dark text-white rounded-pill px-4 py-2 mb-3">
                    <i class="fas fa-industry me-2"></i>KONSULTANSI NON-KONSTRUKSI
                </span>
                <h2 class="display-5 fw-bold text-brown-dark mb-3">Layanan Non-Konstruksi</h2>
                <p class="lead text-brown-medium mx-auto" style="max-width: 600px;">
                    Solusi konsultansi untuk berbagai sektor di luar konstruksi.
                </p>
            </div>
...
<style>
    ...
    .process-step-3d:hover .process-step-inner {
        ...
        box-shadow: 0 30px 50px rgba(93,64,55,0.15);
    }
    ...
    .process-step-3d:hover .step-number-wrapper {
        transform: translateX(-50%) scale(1.1);
        background: linear-gradient(135deg, var(--brown-dark), var(--cream-gold));
    }
    ...
    .step-desc {
        ...
        line-height: 1.5;
        margin-bottom: 0;
    }/* ===== PROCESS STEPS – RAPI DAN SEJAJAR ===== */
.process-step-card {
    background: white;
    border-radius: 1.5rem;
    padding: 2rem 1.5rem;
...
.step-desc {
    ...
    @media (max-width: 768px) {
        ...
        .process-step-inner { padding: 1.5rem 1rem; }
    }
