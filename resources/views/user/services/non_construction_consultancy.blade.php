            ...
            <div class="row min-vh-60 align-items-center">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <h1 class="display-2 fw-bold mb-4 text-brown-dark animate-fade-in-up">
                        Konsultansi <span class="text-gradient-brown">Non‑Konstruksi</span>
                    </h1>
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-nav mt-5 animate-fade-in-up" style="animation-delay: 0.4s;">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item active text-brown-dark" aria-current="page">Konsultansi Non‑Konstruksi</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container position-relative z-2">
            <div class="section-header text-center mb-6">
                <span class="badge bg-brown-dark text-white rounded-pill px-4 py-2 mb-3">
                    <i class="fas fa-tags me-2"></i>BIDANG KEAHLIAN
                </span>
                                    ...
                                    <div class="services-list mb-4">
                                        @foreach(array_slice($category['services'], 0, 3) as $service)
                                            <div class="d-flex mb-2">
                                                ...
                                                <span class="text-brown-medium small">{{ $service }}</span>
                                            </div>
                                        @endforeach
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="benefit-card-3d animate-on-scroll">
                                <div class="benefit-inner">
                                    <div class="benefit-icon-wrapper mb-3">
                                        <i class="fas fa-clock fa-2x text-brown-dark"></i>
                                    </div>
...
<!-- Modal untuk Detail Kategori (3D Premium) -->
...
<div class="modal fade" id="categoryModal{{ $category['id'] }}" tabindex="-1" aria-labelledby="categoryModalLabel{{ $category['id'] }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content category-modal overflow-hidden">
            <div class="modal-header bg-brown-dark text-white py-4">
                <div class="d-flex align-items-center gap-3">
                    <div class="modal-icon-wrapper category-{{ $category['color'] }}">
                        <i class="{{ $category['icon'] }} fa-2x text-white"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold" id="categoryModalLabel{{ $category['id'] }}">{{ $category['category'] }}</h5>
                        <p class="small text-cream-gold mb-0">Konsultansi Non‑Konstruksi</p>
                    </div>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-5">
                <p class="text-brown-medium mb-4">{{ $category['description'] }}</p>

                <h6 class="fw-bold text-brown-dark mb-3"><i class="fas fa-list-check me-2"></i>Layanan yang Tersedia:</h6>
                ...
                <div class="location-input bg-cream-light p-4 rounded-4">
                    <h6 class="fw-bold text-brown-dark mb-3"><i class="fas fa-map-marker-alt me-2"></i>Lokasi Proyek</h6>
                    <div class="input-group">
                        <input type="text" class="form-control border-brown-light" placeholder="Masukkan lokasi proyek Anda">
                        <button class="btn btn-brown-3d" type="button">
            ...
            <div class="modal-footer bg-cream-light px-5 py-4">
                ...
                <a href="{{ route('contact') }}" class="btn btn-brown-3d px-5 py-2 rounded-pill">
...
<style>
    ...
    /* ----- Why Choose Visual (floating icons) ----- */
    .why-choose-visual {
        min-height: 300px;
        position: relative;
    }
    ...
    .category-modal .modal-icon-wrapper {
        width: 60px;
        height: 60px;
        border-radius: 16px;
        display: flex;
    ...
    .category-modal .btn-close-white {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const cards = document.querySelectorAll('.category-card-inner, .benefit-inner');
        cards.forEach(card => {
